...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="assets.php" class="nav-item nav-link">Assets</a>
                        <a href="about.php" class="nav-item nav-link active">About the Developer</a>
                    </div>  
                </div>
            </nav>
                ...
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        <div class="col-12 text-center">
                            <h1 class="text-white animated slideInDown">Developers</h1>
        ...
        <?php
            require_once 'oop/about.php';

            $developer = new Developer();
            $result = $developer->read();
        ?>
        ...
        <div class="container-xxl py-5">
            <div class="container py-5 px-lg-5">
                <div class="wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="text-center mb-5">Developers of the Team</h1>
                </div>
                <div class="row g-4">
                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="team-item bg-light rounded">
                                <div class="text-center border-bottom p-4">
                                    <img class="img-fluid rounded-circle mb-4" src="<?php echo $row['image']; ?>" alt="<?php echo $row['name']; ?>" alt="">
                                    <h5><?php echo $row['name']; ?></h5>
                                </div>
                                <div class="d-flex justify-content-center p-4">
                                    <a class="btn btn-square mx-1" href="<?php echo $row['facebook']; ?>"><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square mx-1" href="<?php echo $row['instagram']; ?>"><i class="fab fa-instagram"></i></a>
                                </div>
                            </div>
                        </div>
                    <?php endwhile; ?>
